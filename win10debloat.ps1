...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/oscarrc/win10script/master/win10debloat.ps1')"
#
#
##########
# Default preset
$tweaks = @(
	...
	"InstallProgs", #Install custom software for me
	...
	"DisabzleUpdateDriver",       	 # "EnableUpdateDriver",
